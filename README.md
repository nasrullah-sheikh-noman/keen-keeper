...
- 🔹 you can text, audio call & video call anyone by using call, text, video button of card details page.
- 🔹 You can see all call & text history of timeline page.
...
- 🔺 Filtering System
- 🔺 Mock Data Integration(JSON Data)
