...
const Friend = ({ friend }) => {
  return (
    <div className="border my-4 mx-1 border-gray-300 shadow-cyan-400 shadow-lg hover:scale-105  hover:shadow-2xl transition transform duration-300 px-6 py-8 flex flex-col items-center text-center space-y-3 rounded-lg">
